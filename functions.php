...
// Somotech          
            array("name" => "midea_360_blue_steel_qty_c", "value" => $midea_360_blue_steel_qty_c ),
            array("name" => "midea_black_469lts_qty_c", "value" => $midea_black_469lts_qty_c ),
            array("name" => "midea_470lts_black_qty_c", "value" => $midea_470lts_black_qty_c ),
            array("name" => "midea_steel_480lt_qty_c", "value" => $midea_steel_480lt_qty_c ),
            array("name" => "midea_black_glass_482lts_qty_c", "value" => $midea_black_glass_482lts_qty_c ),
            array("name" => "midea_capacity_510lts_qty_c", "value" => $midea_capacity_510lts_qty_c ),
            array("name" => "midea_490lts_qty_c", "value" => $midea_490lts_qty_c ),
            array("name" => "midea_500lts_qty_c", "value" => $midea_500lts_qty_c ),
            array("name" => "midea_stainles_640lts_qty_c", "value" => $midea_stainles_640lts_qty_c ),
            array("name" => "midea_stainles_650lts_qty_c", "value" => $midea_stainles_650lts_qty_c ),
            array("name" => "midea_beverage_309ltrs_qty_c", "value" => $midea_beverage_309ltrs_qty_c ),
            array("name" => "midea_washing_mach_8kg_qty_c", "value" => $midea_washing_mach_8kg_qty_c ),
            array("name" => "midea_washer_dryer_10kg_qty_c", "value" => $midea_washer_dryer_10kg_qty_c ),
            array("name" => "midea_washer_dryer_front_qty_c", "value" => $midea_washer_dryer_front_qty_c ),
            array("name" => "midea_washing_mach_12kg_qty_c", "value" => $midea_washing_mach_12kg_qty_c ),
